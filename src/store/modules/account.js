...
import {
  ...
  requestPasswordReset, passwordReset, resendPassword, getAuthCode, confirmAuthCode,
} from '../../api/user';
...
const account = {
  ...
  actions: {
    ...
    GetAuthCode({ commit }, data) {
      return (async () => getAuthCode(data))();
    },

    ConfirmAuthCode({ commit }, data) {
      return (async () => confirmAuthCode(data))();
    },
